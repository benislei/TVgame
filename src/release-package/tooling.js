...
function createReadme() {
  return [
    ...
    '- `启动电视盒子稳定发送.bat`：1080p60 电视盒子兼容档，沿用默认抗花屏档的短 GOP、重复参数集和严格 GOP，只降低码率，优先解决小米盒子等设备队列堆积或画面卡死的问题。',
    ...
    '8. 如果接收端面板显示 FPS 长时间低于 50、队列或解码丢帧持续增长，或者视频重启次数增加，电视盒子优先改用 `启动电视盒子稳定发送.bat`。',
